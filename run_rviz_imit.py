...
if __name__ == "__main__":
    ...
    launch_file = join(base_path, '..', 'jackal_helper/launch/move_base_imitation.launch')
    ...
    while curr_coor[1] < goal_coor[1] and compute_distance(goal_coor, curr_coor) > 1 and not collided and curr_time - start_time < 100:
        curr_time = rospy.get_time()
        pos = gazebo_sim.get_model_state().pose.position
        curr_coor = (pos.x, pos.y)
